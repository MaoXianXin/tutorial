...
trainloader = torch.utils.data.DataLoader(train_data, batch_size=320, shuffle=True, num_workers=8, pin_memory=True)
testloader = torch.utils.data.DataLoader(test_data, batch_size=320, num_workers=8, pin_memory=True)
